...
const  arr = [0,10,20,30]; const fn = function greaterThan10(n) { return n > 10; }// [20,30]
console.log(filter(arr,fn))

// In this example the function filter when invoked filters numbers in arr that are greater than 10.
